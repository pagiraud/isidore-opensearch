...
#	title = "<h1%s>%s</h1>\n" % (ancre,titre)
	...
	lien = "<li class=\"lien_os\"><button onclick=\"javascript:window.external.AddSearchProvider('http://www.insolit.org/isidore-opensearch/" + os_filename + "')\" type=\"button\">Installez le plugin de recherche " + os_shortname + "</button></li>\n"
